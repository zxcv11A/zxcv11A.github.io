...
let songs = [
    {
        ...
        lyrics: [
            ...
            { time: 31.8, text: "อย่างมีความหวัง..." },
            { time: 36.8, text: "อีกไม่ช้าเธอคงมา" },
            { time: 39.0, text: "แต่ตอนนี้ยังไม่มา" },
            { time: 41.5, text: "มันก็นาน ทรมาน" },
            { time: 43.9, text: "ใจฉันกำลังตายช้าๆ" },
            { time: 49.9, text: "โปรดเธออย่าทำแบบนี้เลย" },
            { time: 55.0, text: "ถ้าหากมันเป็นเพราะฉัน" },
            { time: 57.1, text: "ทำให้เธอลังเลแบบนั้น" },
            { time: 59.5, text: "ถ้าเธออยากจบเรื่องของเรา" },
            { time: 61.8, text: "เพราะว่าตอนนี้เธอหมดรักแล้วเธอก็บอก" },
            { time: 69.2, text: "โปรดบอกกันให้รู้" },
            { time: 75.7, text: "ค่ำคืนนี้เธอคงไม่มา" },
            { time: 77.8, text: "And I've been thinking about you" },
            { time: 80.3, text: "รู้ว่าฉันควรต้องตัดใจ" },
            { time: 82.8, text: "But I keep falling back to you" },
            { time: 85.1, text: "ฉันรอฉันรอคำตอบ" },
            { time: 87.7, text: "ฉันรอที่จะได้กอด" },
            { time: 89.8, text: "ฉันรอที่จะได้บอก" },
            { time: 92.1, text: "ว่าฉันรอเธอมาตลอด" },
            ...
            { time: 134.6, text: "And after all that" },
            { time: 135.8, text: "ฉันยังรอคอย เธออย่างไม่มีข้อแม้" },
            { time: 138.0, text: "รอคอยเธอต่อไปแม้ว่าข้างในจะร่อแร่" },
            { time: 140.5, text: "จนใจมันเริ่มจะท้อ ใจมันบอกให้ Fall back" },
            { time: 142.8, text: "แต่เธอก็คงไม่สนว่าฉันจะเป็นยังไง" },
            { time: 144.8, text: "เธอทำให้ฉันนั้นสับสนว่ารักคืออะไร" },
            { time: 147.5, text: "คือ ต้องรอคอยใครสักคนนานๆ ใช่ไหม" },
            { time: 149.5, text: "โดยที่ลึกๆ จะรู้ว่าเขาไม่กลับมาแล้วใช่ไหม" },
            { time: 151.9, text: "Don't talk to me nice ถ้าเธอไม่ได้แคร์" },
            { time: 154.4, text: "ร้องไห้ไปเท่าไหร่ เธอคงไม่ได้แล" },
            ...
            { time: 193.5, text: "ทุกคืนวันช่างทรมาน เมื่อไม่อาจรู้ถึงการมีอยู่" },
    ...
    },
    {
        ...
        artist: "Lady Gaga",
        album: "÷ (Divide)",
        albumArtUrl: "https://t1.blockdit.com/photos/2023/03/6411b25b831bc2931cc2b910_800x0xcover_eu7IRIIc.jpg",
        audioSrc: "audio/Gojo.mp3",
        videoBgSrc: "videos/Gojo.mp4", 
        
        lyrics: [
            { time: 0.0, text: "Judas is the demon I cling to" },
            { time: 6.7, text: "I cling to" },
            { time: 7.9, text: "I'm just a Holy Fool, oh, baby" },
            { time: 9.7, text: "it's so cruel" },
            { time: 11.1, text: "But I'm still in love with Judas, baby" },
            { time: 14.9, text: "I'm just a Holy Fool, oh, baby" },
            { time: 17.8, text: "it's so cruel" },
            { time: 18.7, text: "But I'm still in love with Judas, baby" },
            { time: 22.7, text: "Oh, whoa-whoa, oh-oh" }
        ]
    },
    {
        id: 3,
